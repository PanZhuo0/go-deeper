...
var file_m_proto_rawDesc = []byte{
	0x0a, 0x07, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x22, 0x0a, 0x0c, 0x48, 0x65, 0x6c,
	...
	0x65, 0x70, 0x6c, 0x79, 0x32, 0x31, 0x0a, 0x04, 0x74, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x08,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x6d, 0x65, 0x74,
...
var file_m_proto_depIdxs = []int32{
	...
	1, // 1: test.SayHello:output_type -> HelloResponse
...
func file_m_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_m_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_m_proto_msgTypes[1].Exporter = func(v any, i int) any {
