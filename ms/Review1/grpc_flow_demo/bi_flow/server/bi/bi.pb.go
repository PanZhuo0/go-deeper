...
var file_bi_proto_rawDesc = []byte{
	0x0a, 0x08, 0x62, 0x69, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1d, 0x0a, 0x07, 0x52, 0x65,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x2d, 0x0a, 0x07, 0x47,
	0x72, 0x65, 0x74, 0x74, 0x65, 0x72, 0x12, 0x22, 0x0a, 0x07, 0x62, 0x69, 0x5f, 0x74, 0x65, 0x73,
...
var (
	...
	file_bi_proto_rawDescData = file_bi_proto_rawDesc
)

func file_bi_proto_rawDescGZIP() []byte {
	file_bi_proto_rawDescOnce.Do(func() {
		file_bi_proto_rawDescData = protoimpl.X.CompressGZIP(file_bi_proto_rawDescData)
	})
...
var file_bi_proto_depIdxs = []int32{
	0, // 0: Gretter.bi_test:input_type -> Request
	1, // 1: Gretter.bi_test:output_type -> Response
...
func file_bi_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_bi_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_bi_proto_msgTypes[1].Exporter = func(v any, i int) any {
