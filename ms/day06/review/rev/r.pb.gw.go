...
/*
Package rev is a reverse proxy.
...
func RegisterTestHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TestServer) error {
	...
	mux.Handle("GET", pattern_Test_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.Test/SayHello", runtime.WithHTTPPathPattern("/review/test"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Test_SayHello_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Test_SayHello_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTestHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TestClient) error {
	...
	mux.Handle("GET", pattern_Test_SayHello_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.Test/SayHello", runtime.WithHTTPPathPattern("/review/test"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Test_SayHello_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Test_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"review", "test"}, ""))
)
