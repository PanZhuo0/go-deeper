...
var file_lb_proto_rawDesc = []byte{
	0x0a, 0x08, 0x6c, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x22,
	...
	0x28, 0x09, 0x52, 0x05, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x3c, 0x0a, 0x07, 0x47, 0x72, 0x65,
...
func file_lb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_lb_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_lb_proto_msgTypes[1].Exporter = func(v any, i int) any {
