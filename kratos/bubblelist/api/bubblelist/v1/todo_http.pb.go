...
const OperationTodoCreateTodo = "/api.bubblelist.v1.Todo/CreateTodo"
const OperationTodoDeleteTodo = "/api.bubblelist.v1.Todo/DeleteTodo"
const OperationTodoGetTodo = "/api.bubblelist.v1.Todo/GetTodo"
const OperationTodoListTodo = "/api.bubblelist.v1.Todo/ListTodo"
const OperationTodoUpdateTodo = "/api.bubblelist.v1.Todo/UpdateTodo"

type TodoHTTPServer interface {
	// CreateTodo 基于grpc-gateway 实现提供HTTP服务: 需要提前了解grpc-gateway HTTP与GRPC的映射规则
